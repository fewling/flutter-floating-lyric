...
class LrcLibRepository with CustomExceptionHandler {
  static const _baseUrl = 'https://lrclib.net/api';

  Future<Result<LrcLibResponse, CustomException>> getLyric({
    ...
    return tryRunAsync(() async {
      ...
      if (response.statusCode != 200) {
        if (kDebugMode) {
          logger.e(
            'Failed to get lyric from LrcLib, response: ${response.body}',
          );
        }
