...
class PreferenceBloc extends Bloc<PreferenceEvent, PreferenceState> {
  PreferenceBloc({required PreferenceService spService})
    ...
    on<PreferenceEvent>(
      (event, emit) => switch (event) {
        ...
        LocaleUpdated() => _onLocaleUpdated(event, emit),
      },
    );
  }
  ...
  Future<void> _onShowMillisecondsToggled(
    ShowMillisecondsToggled event,
    Emitter<PreferenceState> emit,
  ) async {
    final isSuccess = await _spService.toggleShowMilliseconds(
  ...
  Future<void> _onShowProgressBarToggled(
    ShowProgressBarToggled event,
    Emitter<PreferenceState> emit,
  ) async {
    final isSuccess = await _spService.toggleShowProgressBar(
  ...
  Future<void> _onAutoFetchOnlineToggled(
    AutoFetchOnlineToggled event,
    Emitter<PreferenceState> emit,
  ) async {
    final isSuccess = await _spService.toggleAutoFetchOnline(
  ...
  Future<void> _onEnableAnimationToggled(
    EnableAnimationToggled event,
    Emitter<PreferenceState> emit,
  ) async {
    final isSuccess = await _spService.toggleEnableAnimation(
